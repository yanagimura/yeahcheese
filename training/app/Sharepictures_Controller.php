...
require_once 'Sharepictures_Error.php';
require_once 'Sharepictures_ActionClass.php';
 ...
 *  @package    Sharepictures
 */
class Sharepictures_Controller extends Ethna_Controller
{
    /**#@+
     *  @access protected
     */
    ...
    protected $forward = array(
         ...
         *
         *  'index'         => array(
         *      'view_name' => 'Sharepictures_View_Index',
         *  ),
         */
    );
    ...
    public $class = array(
        ...
        'form'          => 'Sharepictures_ActionForm',
        'i18n'          => 'Ethna_I18N',
        'logger'        => 'Ethna_Logger',
        'plugin'        => 'Ethna_Plugin',
        'session'       => 'Ethna_Session',
        'view'          => 'Sharepictures_ViewClass',
        'renderer'      => 'Ethna_Renderer_Smarty',
        'url_handler'   => 'Sharepictures_UrlHandler',
    );
